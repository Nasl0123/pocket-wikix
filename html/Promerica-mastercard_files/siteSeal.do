...
function ss_open_sub(){
  ...
  ss_url_p1          = "21f3c4a4"
  ss_url_p2          = "ba5eefde8f89f2785d18ba57e27a3a947fc573f5fa01b38ccdd4a020434be50ffe2a79cf5b826db4a406aa9dcf9195715d1abb4ebe3b7a8f"
  ss_url_p3          = "97be7700c56679010085f0edfe82264942c2ac1f"
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=15:05:24(UTC)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=15:05:24(UTC)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
